		...
		return this.each(function(){
			$(this).focusout(function(e){
                if(this.value != ""){
                    ...
                    console.info(valida(this.value));
                    if(valida(this.value)){
                            $(this).closest(selected.parent).addClass("control-group success").removeClass("error");
                    }else{
                            $(this).closest(selected.parent).addClass("control-group error").removeClass("success");
                    }
                }
                e.stopPropagation();
			})
